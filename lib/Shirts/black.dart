...
import 'package:ar_cart/shirts/shirts.dart';
...
class Black extends StatefulWidget {
  ...
  const Black({Key? key, required this.user, required this.cart})
      : super(key: key);
...
class _BlackState extends State<Black> {
  void _addToCart(BuildContext context) {
    setState(() {
      widget.cart.add('Black shirts'); // Add item to the cart
    });

    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('tshirt added to your cart.'),
                          ...
                          children: [
                            Container(
                              ...
                              child: Stack(children: [
                                Image.asset(
                                  'assets/images/shirts/black.png',
                                  fit: BoxFit.cover,
                                  width: double.infinity,
                                  height: double.infinity,
                                ),
                        ...
                        Column(
                          children: [
                            Container(
                              ...
                              color: Colors.white12,
                              child: Image.asset(
                                'assets/images/shirts/blackT.jpg',
                                fit: BoxFit.cover,
                              ),
                            ),
                          ],
